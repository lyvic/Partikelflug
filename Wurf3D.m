...
##		
		...
		function 	dy= Vtsv(x,y,rhop,rhog,grav,eta,dp,k,c,m)
			...
			((c.*abs(y(1))).^0.8./461000)).*k.*abs(y(1)).^2./m - grav + (rhog./rhop.*grav));...
			y(1)];
		endfunction
	...
	## Gekoppelte DGLs
		...
		## 
        function 	dy= Vts3D(x,y,rhop,rhog,grav,eta,dp,windx,windy,windz,k,c,m)
			dy= [(-sign((y(1)+windx)).*((24./(c.*sqrt(((y(1)+windx).^2)+ ...
			((y(2)+windy).^2)+((y(3)+windz).^2))))+(2.6.*((c.*sqrt(((y(1)+windx).^2)+ ...
			((y(2)+windy).^2)+((y(3)+windz).^2)))./5))./(1+((c.*sqrt(((y(1)+windx).^2)+ ...
			((y(2)+windy).^2)+((y(3)+windz).^2)))./5).^1.52)+(0.411.*((c.*sqrt(((y(1)+windx).^2)+ ...
			((y(2)+windy).^2)+((y(3)+windz).^2)))./263000).^-7.94)./(1+((c.*sqrt(((y(1)+windx).^2)+ ...
			((y(2)+windy).^2)+((y(3)+windz).^2)))./263000).^-8)+((c.*sqrt(((y(1)+windx).^2)+ ...
			((y(2)+windy).^2)+((y(3)+windz).^2))).^0.8./461000)).*k.*sqrt(((y(1)+windx).^2)+ ...
			((y(2)+windy).^2)+((y(3)+windz).^2)).*abs(y(1)+windx)./m); ...
			...
			((y(2)+windy).^2)+((y(3)+windz).^2)))./263000).^-8)+((c.*sqrt(((y(1)+windx).^2)+ ...
			((y(2)+windy).^2)+((y(3)+windz).^2))).^0.8./461000)).*k.*sqrt(((y(1)+windx).^2)+ ...
			((y(2)+windy).^2)+((y(3)+windz).^2)).*abs(y(2)+windy)./m); ...
			(-sign((y(3)+windz)).*((24./(c.*sqrt(((y(1)+windx).^2)+((y(2)+windy).^2)+ ...
			((y(3)+windz).^2))))+(2.6.*((c.*sqrt(((y(1)+windx).^2)+((y(2)+windy).^2)+ ...
			((y(3)+windz).^2)))./5))./(1+((c.*sqrt(((y(1)+windx).^2)+((y(2)+windy).^2)+ ...
			((y(3)+windz).^2)))./5).^1.52)+(0.411.*((c.*sqrt(((y(1)+windx).^2)+((y(2)+windy).^2)+ ...
			((y(3)+windz).^2)))./263000).^-7.94)./(1+((c.*sqrt(((y(1)+windx).^2)+((y(2)+windy).^2)+ ...
			((y(3)+windz).^2)))./263000).^-8)+((c.*sqrt(((y(1)+windx).^2)+((y(2)+windy).^2)+ ...
			((y(3)+windz).^2))).^0.8./461000)).*k.*sqrt(((y(1)+windx).^2)+((y(2)+windy).^2)+ ...
			((y(3)+windz).^2)).*abs(y(3)+windz)./m -grav + (rhog./rhop.*grav)); ...
			y(1); ...
			y(2); ...
			y(3)];
            %    Vx   ;Vy   ;Vz   ;X    ;Y    ;Z
